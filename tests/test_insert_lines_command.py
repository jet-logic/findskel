...
class TestInsertLinesCommand(unittest.TestCase):
    ...
    def run_insert_lines(self, *args):
    ...
    def test_basic_insertion(self):
        ...
        # Run the command
        result = self.run_insert_lines(
            str(self.source_file), "--search", str(self.test_dir), "--act"
        )
    ...
    def test_dry_run(self):
        ...
        # Run with dry-run
        result = self.run_insert_lines(
            str(self.source_file), "--search", str(self.test_dir), "--dry-run"
        )
    ...
    def test_missing_template(self):
        ...
        result = self.run_insert_lines(
            str(self.source_file), "--search", str(self.test_dir)
        )
    ...
    def test_multiple_files(self):
        ...
        result = self.run_insert_lines(
            str(self.source_file), str(source2), "--search", str(self.test_dir)
        )
